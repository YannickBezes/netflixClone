<template>
  ...
  <div id="ana">
    ...
    <app-big-video v-if="isLoading" :selectType="'Series'" :database="database"></app-big-video>

    <div id="slider" v-if="isLoading">
      <app-slider :database="database" :type="'Series'" :filterData="'category'" :searchValue="'Immersive'"
                  class="app-slider" @indexSensor="index_sensor($event)"></app-slider>
      <app-slider :database="database" :type="'Series'" :filterData="'category'" :searchValue="'Emotional'"
                  class="app-slider" @indexSensor="index_sensor($event)"></app-slider>
      <app-slider :database="database" :type="'Series'" :filterData="'category'"
                  :searchValue="'Science Fiction & Fantasy'" class="app-slider"
                  @indexSensor="index_sensor($event)"></app-slider>
      <app-slider :database="database" :type="'Series'" :filterData="'category'" :searchValue="'Domestic Series'"
                  class="app-slider" @indexSensor="index_sensor($event)"></app-slider>
      <app-slider :database="database" :type="'Series'" :filterData="'category'" :searchValue="'Action'"
                  class="app-slider" @indexSensor="index_sensor($event)"></app-slider>
      <app-slider :database="database" :type="'Series'" :filterData="'category'" :searchValue="'Comedies'"
                  class="app-slider" @indexSensor="index_sensor($event)"></app-slider>
      <app-slider :database="database" :type="'Series'" :filterData="'category'" :searchValue="'Action'"
                  class="app-slider" @indexSensor="index_sensor($event)"></app-slider>
    </div>
...
export default {
  ...
  created() {
    if (this.$route.fullPath.match('id')) {
      this.$router.push('/browse/series');
    }
  }
};
</script>
